...
public class Admin extends JFrame implements ActionListener{
    ...
    Admin() {
        ...
        JLabel AccountNo = new JLabel("Admin UserName");
        ...
        JLabel pin = new JLabel("Admin Password");
...
//        add(reset);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == reset) {
            ...
            String query = "select *from alogin where ausername = '" + Accountno + "' and apassword = '" + pin + "'";
            try {
                ...
                if (rs.next()) {
                    setVisible(false);
                    new Transactions1(pin,Accountno).setVisible(true);
                } else {

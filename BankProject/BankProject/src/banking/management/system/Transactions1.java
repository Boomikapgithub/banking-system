...
public class Transactions1 extends JFrame implements ActionListener
{
  ...
  Transactions1(String pin, String Accountno)
  {
...
//    add(image3);
    ...
    add(l1);
     ...
     b1 = new JButton("View Customer Account Request");
     ...
     b2 = new JButton("View Existing Customer");
     ...
     b4 = new JButton("Request NetBanking");
     ...
     b5 = new JButton("Request ChequeBook");
     ...
     b6 = new JButton("Add- On Services");
